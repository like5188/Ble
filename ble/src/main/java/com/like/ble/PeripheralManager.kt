...
import com.like.ble.state.PeripheralStateManager
 ...
 */
class PeripheralManager(private val mActivity: FragmentActivity) {
    private val mStateManager: PeripheralStateManager by lazy { PeripheralStateManager(mActivity) }
