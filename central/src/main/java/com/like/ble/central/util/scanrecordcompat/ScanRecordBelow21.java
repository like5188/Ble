...
/**
 * 复制的 ScanRecord 的代码，因为 ScanRecord 是 android 21 才加入的。
 * Represents a scan record from Bluetooth LE scan.
 */
public final class ScanRecordBelow21 {

    private static final String TAG = "ScanRecordBelow21";
    ...
    private ScanRecordBelow21(List<ParcelUuid> serviceUuids,
    ...
    /**
     * Parse scan record bytes to {@link ScanRecordBelow21}.
     * <p>
    ...
    public static ScanRecordBelow21 parseFromBytes(byte[] scanRecord) {
        ...
        try {
            ...
            return new ScanRecordBelow21(serviceUuids, serviceSolicitationUuids, manufacturerData,
                    serviceData, advertiseFlag, txPowerLevel, localName, scanRecord);
        } catch (Exception e) {
            Log.e(TAG, "unable to parse scan record: " + Arrays.toString(scanRecord));
            // As the record is invalid, ignore all the parsed results for this packet
            // and return an empty record with raw scanRecord bytes in results
            return new ScanRecordBelow21(null, null, null, null, -1, Integer.MIN_VALUE, null, scanRecord);
        }
    }

    @Override
    public String toString() {
        return "ScanRecordBelow21 [mAdvertiseFlags=" + mAdvertiseFlags + ", mServiceUuids=" + mServiceUuids
